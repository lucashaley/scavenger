module Zif
  module Layers
    ...
    module Layerable
      ...
      # Addition by Lucas Haley
      def find_intersect_rect(given_rect)
        puts "source_sprites: #{@source_sprites}"
        puts "given_rect: #{given_rect}"
        puts "result: #{$gtk.args.geometry.find_intersect_rect given_rect, @source_sprites}"
      end

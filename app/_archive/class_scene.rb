class ClassScene < Zif::Scene
  ...
  def prepare_scene
    ...
    @button_north = ExampleApp::TallButton.new(:static_button, 160, :eight, 'N', 2)
    @button_north.x = 360 - 80
    @button_north.y = 128 + 192 + @ui_viewscreen_border
    @button_south = ExampleApp::TallButton.new(:static_button, 160, :eight, 'S', 2)
    @button_south.x = 360 - 80
    @button_south.y = 128
    @button_east = ExampleApp::TallButton.new(:static_button, 160, :eight, 'E', 2)
    @button_east.x = 360 + 80 + @ui_viewscreen_border
    @button_east.y = 128 + 80
    @button_west = ExampleApp::TallButton.new(:static_button, 160, :eight, 'W', 2)
    @button_west.x = 360 - 80 - @ui_viewscreen_border - 160
    @button_west.y = 128 + 80
    @button_ccw = ExampleApp::TallButton.new(:static_button, 160, :eight, 'CCW', 2) do |point|
    ...
    @button_cw = ExampleApp::TallButton.new(:static_button, 160, :eight, 'CW', 2) do |point|

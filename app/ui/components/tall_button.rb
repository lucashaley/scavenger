module ExampleApp
  ...
  class TallButton < Zif::UI::TwoStageButton
    ...
    VALID_COLORS = %i[blue green red yellow white eight nine].freeze

    EDGE_WIDTH = 6
    PRESSED_HEIGHT = 192
    NORMAL_HEIGHT = 196

    def initialize(name=Zif.unique_name('tall_button'), width=140, color=:blue, label_text=nil, label_size=-1, &block)
      super(name, &block)
